...
flowchart TD
    ...
    %% Node Styles
    style A fill:#ffcccb,stroke:#b22222,stroke-width:2px,color:#000
    style B fill:#87cefa,stroke:#1e90ff,stroke-width:2px,color:#000
...
## Project's Output
<p align="center">
  <img src="ThingSpeak.png" alt="Image 1" width="75%"/> 
</p>
 
<p align="center">
  <img src="Serial Monitor.png" alt="Image 1" width="75%"/>
</p>
